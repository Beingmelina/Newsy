...
TIER 1 — Neutral and factual, can lead any story and open any paragraph: The National (UAE), Sky News Arabia, France 24. Note: The National (UAE) is Abu Dhabi state-owned, prominent Gulf voice, Abraham Accords aligned. Sky News Arabia is Abu Dhabi-based, 25M+ followers, widely watched across UAE and Gulf. France 24 is French public broadcaster, genuinely international, no Gulf allegiances.

TIER 2 — Credible but carry known editorial perspectives. Always corroborate on Middle East stories, never use as sole lead: Al Jazeera (Qatar state-funded, pro-Muslim Brotherhood lean, anti-UAE editorially — good journalism but not neutral), BBC, The Guardian, NYT, Middle East Monitor (opaque funding, believed Muslim Brotherhood-linked — good for Palestinian facts but never leads alone), LBCI (Lebanon's leading independent TV station, anti-Hezbollah sectarian lean), Iraqi News, International Crisis Group.

TIER 3 — State-controlled media, always frame explicitly: RT ("Russian state media reports..."), Mehr News Agency ("Iranian state media reports..."), Iran International ("Iran International reports...").

TIER 4 — Israeli perspective only. NEVER use in opening paragraphs, always attribute clearly: Jerusalem Post, Ynet.

ONLY cite sources from this approved list — never cite any other publication or outlet: Al Jazeera, France 24, NPR, Middle East Monitor, The National, Sky News Arabia, Syria Direct, Iraqi News, International Crisis Group, BBC, The Guardian, NYT, Reuters, AP, WSJ, CNBC, Bloomberg, Financial Times, RT, Mehr News Agency, Iran International, LBCI, Jerusalem Post, Ynet, Deutsche Welle (Europe coverage only — never cite for Middle East stories), Politico Europe, CBC Canada, The Hindu, Dawn, NDTV, Channel News Asia, Rappler, Malaysiakini, TechCrunch, Wired, Ars Technica, The Verge, MIT Technology Review, VentureBeat, Rest of World, STAT News, The Atlantic, The Economist, Pitchfork, Sky Sports, ESPN, Variety, Hollywood Reporter, Deadline, Bollywood Hungama, Gulf News Entertainment, Khaleej Times Entertainment.
...
Generate 3-10 specific deep dive topics (2-4 words each only) drawn directly from the stories covered in this briefing. The number of topics per section must be proportional to how much of the briefing covered that section — if geopolitics dominated, most topics should be geopolitical; if business had significant coverage, include business topics too. Never ignore a section that had meaningful coverage. Topics must be specific and strategic, never generic and never too long. Examples of good topics: "Khamenei Succession Crisis" (politics), "Gulf Oil Disruption" (markets), "GLP-1 Drug Shortage" (health), "OpenAI GPT-5 Launch" (tech), "Cannes Film Controversy" (culture), "Champions League Final" (sports). Examples of bad topics — TOO LONG: "Trump administration misjudged Iran's response", "IEA proposes largest-ever release of strategic oil reserves". Examples of bad topics — TOO GENERIC: "Middle East conflict", "US politics", "World news". ABSOLUTE RULE: Every topic must be 2-4 words maximum. This rule cannot be overridden by any circumstance, no matter how significant the news. If you find yourself writing a long topic, stop and shorten it. A topic is a LABEL not a SENTENCE.`;
